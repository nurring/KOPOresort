...
<%
	...
	String QueryTxt;
	QueryTxt = String
			.format("SELECT id, title, date, viewcnt FROM resortboarditem where board_id = 1 order by id desc");
...
<body>
	...
	<div class="container"
		style="padding: 150px 50px 50px 50px; min-height: 720px;">
		...
		<table>
			<tr>
				<td style="align: right;"><button type="button"
						class="btn btn-dark"
						onclick="location.href='?contentPage=e_01_insert.jsp&board=1'">새
						글 쓰기</button></td>
			</tr>
		</table>
		<%}  %>
