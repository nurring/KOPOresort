...
<%
	...
	ResultSet rset = stmt.executeQuery(
			"select id,title,date,viewcnt,content,imgurl from resortboarditem where id=" + id + ";");
%>
</head>
<body>
	<div>
			...
			<table>
				<tr>
					<td><button class="btn btn-dark" type="button"
							onclick="location.href='?contentPage=e_01.jsp'">목록</button> <%
 	String loginOK = null;
 ...
 %>
						...
						<button class="btn btn-dark" type="button"
							onclick="location.href='?contentPage=e_01_delete.jsp&key=<%=id %>&board=1'">삭제</button>
						<%}  %></td>
				</tr>
			</table>
		</div>
